<?= view('employe/layout/header', [
    'title' => 'DASHBOARD EMPLOYÉ',
    'sectionId' => 'page-dashboard-employe',
]) ?>
<?= view('employe/sidebar/sidebar', [
...
<?= view('employe/footer/footer', [
    'footerYear' => '2025',
    'footerText' => 'TechMada RH',
    'footerSuffix' => ' — Projet CodeIgniter 4',
]) ?>